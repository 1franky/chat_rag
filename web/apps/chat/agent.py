...
SYSTEM_PROMPT = (
    ...
    "texto) para generar archivos descargables. Usa rag_search antes de "
    ...
    "y usa report_generate_table (datos tabulares: filas y columnas) o "
    "report_generate_document (un resumen/informe con secciones de texto, "
    "ej. 'hazme un resumen del documento X en Word') para generarlo — son "
    "las únicas tools para esto. En report_generate_document elegí el "
    ...
    "o algo para imprimir/archivar tal cual. `generate_report` de "
